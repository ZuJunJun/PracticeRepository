...
public class SpringIndicator extends View {
    ...
    private void setStyleable(Context context, AttributeSet attrs) {
        TypedArray array = context.obtainStyledAttributes(attrs, R.styleable.SpringIndicator);
        mSelected_color = array.getColor(R.styleable.SpringIndicator_vpi_selected_color, 0xffffffff);
        mDefault_color = array.getColor(R.styleable.SpringIndicator_vpi_default_color, 0xffcdcdcd);
        mRadius = array.getDimension(R.styleable.SpringIndicator_vpi_radius, 20);//px
        mLength = array.getDimension(R.styleable.SpringIndicator_vpi_length, 2 * mRadius);//px
        mDistance = array.getDimension(R.styleable.SpringIndicator_vpi_distance, 3 * mRadius);//px
        mDistanceType = array.getInteger(R.styleable.SpringIndicator_vpi_distanceType, DistanceType.BY_RADIUS);
        mIndicatorType = array.getInteger(R.styleable.SpringIndicator_vpi_indicatorType, IndicatorType.CIRCLE);
        mNum = array.getInteger(R.styleable.SpringIndicator_vpi_num, 0);
        mAnimation = array.getBoolean(R.styleable.SpringIndicator_vpi_animation, true);
        array.recycle();
        switch (mIndicatorType) {
     ...
     * @param num
     */
    public SpringIndicator setNum(int num) {
        mNum = num;
        invalidate();
        return this;
    }
     ...
     * @param indicatorType
     */
    public SpringIndicator setType(int indicatorType) {
     ...
     * @param radius
     */
    public SpringIndicator setRadius(float radius) {
        this.mRadius = radius;
        invalidate();
        return this;
    }
     ...
     * @param distance
     */
    public SpringIndicator setDistance(float distance) {
     ...
     * @param mDistanceType
     */
    public SpringIndicator setDistanceType(int mDistanceType) {
     ...
     * @return
     */
    public SpringIndicator setViewPager(ViewPager viewPager) {
     ...
     * @return
     */
    public SpringIndicator setViewPager(ViewPager viewpager, int CycleNumber) {
     ...
     * @return
     */
    public SpringIndicator setViewPager(ViewPager viewPager, boolean isInfiniteCircle) {
     ...
     * @return
     */
    public SpringIndicator setViewPager(ViewPager viewpager, int CycleNumber, boolean isInfiniteCircle) {
        mNum = CycleNumber;
