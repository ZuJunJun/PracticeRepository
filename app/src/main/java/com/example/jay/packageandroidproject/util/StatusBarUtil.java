...
public class StatusBarUtil {
    ...
    public static void setStatusBarColor(Activity activity, int statusColor) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            setLollipopStatusBarColor(activity, statusColor);
        } else if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            setKitKatStatusBarColor(activity, statusColor);
        }
    }

    private static void setKitKatStatusBarColor(Activity activity, int statusColor) {
    ...
    private static void setLollipopStatusBarColor(Activity activity, int statusColor) {
        Window window = activity.getWindow();
        //取消状态栏透明
