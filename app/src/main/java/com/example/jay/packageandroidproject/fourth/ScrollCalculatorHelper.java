...
//    }
    ...
    void playVideo(RecyclerView view) {
        ...
        boolean needPlay = false;
            if (layoutManager.getChildAt(0) != null && layoutManager.getChildAt(0).findViewById(playId) != null) {
                GSYBaseVideoPlayer player = (GSYBaseVideoPlayer) layoutManager.getChildAt(0).findViewById(playId);
                Rect rect = new Rect();
